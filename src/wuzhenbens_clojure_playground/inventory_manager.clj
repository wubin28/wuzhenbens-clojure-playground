(ns wuzhenbens-clojure-playground.inventory-manager
...
(-main)
; Output:
;Current inventory: Current inventory: Current inventory:    Current inventory:  10
;10
;10
;Current inventory:  7
;Order confirmed for  1  items
;Item added to cart and order confirmed
;Order confirmed for  Current inventory:  51  items
;Order confirmed for  Item added to cart and order confirmed1  items
;Item added to cart and order confirmed
;Order confirmed for  1  itemsCurrent inventory:  Order confirmed for  7
;Order confirmed for  1  items
;Item added to cart and order confirmed
;Order confirmed for  1  items
;Item added to cart and order confirmed
...
;
;
;Inventory change:Item added to cart and order confirmed4
;1  items
;Order confirmed for Item added to cart and order confirmed
;Current inventory:  3
;
;-1 1  items
;
